...
const cors = require("cors");  //모든 브라우져가 내서버에 요청할 수 있도록
const app = express();
// 헤로쿠에 포트 지정하는게 있으면 그번호를 사용
// 없으면 8080포트를 사용
...
app.post('/image', upload.single('image'), (req, res)=>{
    ...
    console.log(file);
    res.send({
        imageUrl: "https://lamp-server5675.herokuapp.com/"+file.destination+file.filename
    })
})
...
app.post("/products",(req, res)=>{
    ...
    //Product테이블에 레코드를 삽입 create가 insert문임 
